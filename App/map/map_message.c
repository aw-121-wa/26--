...
NODE Node[136] = {
    ...
    {N10, DLEFT|DRIGHT|RIGHT_LINE, 180, 200, SPEED4, NONE},
    ...
    /* C4 (2邻居) */
    {C8, MORELED|DRIGHT|CRIGHT, 90, 150, SPEED3, NONE},
    ...
    /* C7 (2邻居) */
    {N14, DRIGHT|CRIGHT, -90, 190, SPEED4, NONE},
    {C8, DLEFT|STOPTURN, 180, 100, SPEED2, NONE},
    /* C8 (2邻居) */
    {C7, MORELED|STOPTURN|DRIGHT|CRIGHT|RESTMPUZ, 0, 140, SPEED3, NONE},
