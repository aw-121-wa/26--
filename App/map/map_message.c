...
NODE Node[126] = {
    ...
    /* P3 */  {N3, DRIGHT|MORELED, 180, 205, SPEED3, NONE},
    /* N3 (5邻居) */
    ...
    /* N8 (4邻居) */
    {N3, CLEFT|LEFT_LINE|MUL2MUL, -45, 60, SPEED0, NONE},
    {N10, MUL2MUL, 33, 140, SPEED3, NONE},
    {N12, MUL2MUL, 140, 270, SPEED3, NONE},
    {N5, STOPTURN|CLEFT, -140, 150, SPEED0, NONE},
    /* C1 (2邻居) */
    ...
    {N3, DLEFT|DRIGHT|STOPTURN, -90, 180, SPEED3, NONE},
    ...
    /* N20 (3邻居) */
    {C4, MORELED|CLEFT|MCLEFT|STOPTURN, -42, 230, SPEED4, NONE},
    ...
    /* C8 (2邻居) */
    {C7, MORELED|STOPTURN|DRIGHT|CRIGHT|RESTMPUZ, 0, 140, SPEED2, NONE},
