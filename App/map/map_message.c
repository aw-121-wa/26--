...
NODE Node[136] = {
    ...
    /* ---- P1 (1) ---- */
    /*P1 -> N1*/  {N1, CRIGHT|LEFT_LINE|STOPTURN, 180, 30, SPEED2, NONE},
    ...
    {N18, CRIGHT|CLEFT, 45, 190, SPEED5, NONE},
    ...
    /* C4 (2邻居) */
    {C8, MORELED|DRIGHT|CRIGHT, 90, 150, SPEED5, NONE},
    ...
    /* C8 (2邻居) */
    {C7, MORELED|STOPTURN|DRIGHT|CRIGHT|RESTMPUZ, 0, 140, SPEED5, NONE},
...
uint8_t Address[57] = {
    ...
    98, 101, 103, 104, 107, 111, 113, 115, 117, 119,
